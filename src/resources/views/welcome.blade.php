    ...
    <div class="container">
      <div class="row">
        ...
        <div class="mx-auto col-lg-5 col-md-5 col-10">
          <img src="{{ asset('front/images/ben.jpg') }}" class="img-fluid" alt="Ben Resume HTML Template">
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-12">
          ...
          <p>Ben Resume HTML Template is brought to you by <a rel="nofollow" href="https://www.tooplate.com"
              target="_parent">Tooplate website</a>. You can feel free to edit and use this page for your small site.
            You are allowed to use this HTML template for any kind of purpose.</p>

          <p>However, please do not re-distribute the downloadable template ZIP file on any template collection website.
            This is strongly prohibited. Please contact Tooplate for more information.</p>
        ...
        <div class="col-lg-5 mx-auto col-md-6 col-12">
          <img src="{{ asset('front/images/true-agency.jpg') }}" class="about-image img-fluid" alt="Ben's Resume HTML Template">
        </div>
      ...
      <div class="row about-third">
        <div class="col-lg-4 col-md-4 col-12">
          ...
          <p>Sed eu risus tincidunt, finibus dolor non, gravida ex. Donec lacinia mi nec erat tempus, vel consectetur
            ante scelerisque. Ut blandit, risus in venenatis ultricies, lacus tellus fermentum.</p>
        </div>
        <div class="col-lg-4 col-md-4 col-12">
          <h3>Mauris semper</h3>
          <p>Cras et nisl vestibulum, accumsan elit sed, pretium enim. Vestibulum in condimentum magna. Maecenas quam
            magna, iaculis eu turpis et, commodo pulvinar leo.</p>
        </div>
        <div class="col-lg-4 col-md-4 col-12">
          <h3>Integer id neque</h3>
          <p>Duis at mollis leo, venenatis congue ex. Cras urna dui, gravida euismod lectus et, cursus tempor nulla.
            Praesent at turpis quis ex tristique gravida quis eget eros.</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-12">
          ...
          <div class="owl-carousel owl-theme" id="testimonials-carousel">
            <div class="item">
              <div class="testimonials-thumb d-flex">
                <div class="testimonials-image">
                  <img src="{{ asset('front/images/testimonials/testimonial-image01.jpg') }}" class="img-fluid" alt="testimonials image">
                </div>
            ...
            <div class="item">
              <div class="testimonials-thumb d-flex">
                <div class="testimonials-image">
                  <img src="{{ asset('front/images/testimonials/testimonial-image02.jpg') }}" class="img-fluid" alt="testimonials image">
                </div>
            ...
            <div class="item">
              <div class="testimonials-thumb d-flex">
                <div class="testimonials-image">
                  <img src="{{ asset('front/images/testimonials/testimonial-image03.jpg') }}" class="img-fluid" alt="testimonials image">
                </div>
            ...
            <div class="item">
              <div class="testimonials-thumb d-flex">
                <div class="testimonials-image">
                  <img src="{{ asset('front/images/testimonials/testimonial-image04.jpg') }}" class="img-fluid" alt="testimonials image">
                </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-12">
          ...
          <div class="accordion" id="accordionExample">
            ...
            <span class="faq-info-text">Please send us a message if you have anything to say. Send an email message to
              <strong>contact (at) tooplate (dot) com</strong></span>
